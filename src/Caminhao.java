public class Caminhao extends AutoMotor {
    ...
    // Construtor Caminhão
    public Caminhao(String modelo, int anoFabricacao, String marca, String cor, String montadora, double kilometragem, int quantidadeEixos, double pesoBruto) {
        super(modelo, anoFabricacao, marca, cor, montadora, kilometragem);
